...
rm -f %{buildroot}/%{_mandir}/man*/dbus-launch*
...
%changelog
* Sun Dec 19 2010 Sergio Rubio <rubiojr@frameos.org> - 1:1.2.24-4
- Do not build doc and X11 packages

* Mon Aug  9 2010 Colin Walters <walters@redhat.com> - 1:1.2.24-3
- Actually apply previous patch
- Resolves: #585119

* Fri Jul  9 2010 Colin Walters <walters@redhat.com> - 1:1.2.24-2
- Backport corrected patch from upstream for init script
- Resolves: #585119

* Wed Mar 24 2010 Colin Walters <walters@redhat.com> - 1:1.2.24-1
- New upstream release
  Resolves: #576700
- Drop upstreamed patches
- Syncs with F-13

* Fri Jan 22 2010 Ray Strode <rstrode@redhat.com> - 1:1.2.16-11
Resolves: 557790
- Drop dep on dbus from dbus-libs

* Tue Jan 12 2010 Matthias Clasen <mclasen@redhat.com> - 1:1.2.16-10
- Rebuild against new libaudit
- Don't link libdbus against libcap
